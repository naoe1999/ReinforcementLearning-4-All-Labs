...
class DQN:
    ...
    def copy_to(self, target_dqn):
        target_dqn.W1.assign(self.W1.value())
        target_dqn.W2.assign(self.W2.value())

    def copy_from(self, source_dqn):
        self.W1.assign(source_dqn.W1.value())
        self.W2.assign(source_dqn.W2.value())
...
def main():
    ...
    for episode in range(MAX_EPISODES):
        ...
        if len(reward_list) > 30 and np.mean(reward_list[-30:]) > 10000:
            break
        ...
        if episode % 10 == 1:
            ...
            for i in range(50):
                ...
                loss = replay_train(mainDQN, targetDQN, minibatch, DISCOUNT_RATIO)
